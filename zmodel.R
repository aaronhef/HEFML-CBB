...
predictions_2025 <- as.data.table(processed_data_current)[, 
  `:=`(
...
source("build_hefml_hoops_site_with_grid_v7.R")

build_hefml_hoops_site(
  pred_data = predictions_2025,
  output_file = "hefml_hoops_with_favored_grid.html"
)